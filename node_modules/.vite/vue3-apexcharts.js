  ...
  "node_modules/apexcharts/dist/apexcharts.common.js"(exports, module) {
    ...
    var b = function() {
      ...
      return a(t2, [{ key: "drawLine", value: function(t3, e2, i2, a2) {
        ...
        I2 = Array.isArray(M2) ? M2[a2] : A2.config.stroke.dashArray;
        var z2 = this.drawPath({ d: e2, stroke: n2, strokeWidth: l2, fill: c2, fillOpacity: 1, classes: p2, strokeLinecap: h2, strokeDashArray: I2 });
        if (z2.attr("index", a2), v2 && z2.attr({ "clip-path": "url(#gridRectMask".concat(A2.globals.cuid, ")") }), A2.config.states.normal.filter.type !== "none")
        ...
        return !L2 || A2.globals.resized || A2.globals.dataChanged ? !A2.globals.resized && A2.globals.dataChanged || C2.showDelayedElements() : C2.animatePathsGradually(o(o({}, E2), {}, { speed: g2 })), A2.globals.dataChanged && P2 && T2 && C2.animatePathsGradually(o(o({}, E2), {}, { speed: u2 })), z2;
    ...
    var I = function() {
      ...
      return a(t2, [{ key: "handleBarDataLabels", value: function(t3) {
        ...
        var u2 = new M(this.barCtx.ctx), p2 = new b(this.barCtx.ctx), f2 = c2.formatter, x2 = null, v2 = d2.globals.collapsedSeriesIndices.indexOf(s2) > -1;
        if (c2.enabled && !v2) {
          x2 = p2.group({ class: "apexcharts-data-labels", transform: g2 });
          var m2 = "";
          a2 !== void 0 && (m2 = f2(a2, { seriesIndex: s2, dataPointIndex: r2, w: d2 }));
          ...
          var k2 = o({}, c2);
          this.barCtx.isHorizontal && a2 < 0 && (c2.textAnchor === "start" ? k2.textAnchor = "end" : c2.textAnchor === "end" && (k2.textAnchor = "start")), u2.plotDataLabelsText({ x: e2, y: i2, text: m2, i: s2, j: r2, parent: x2, dataLabelsConfig: k2, alwaysDrawDataLabel: true, offsetCorrection: true });
        }
        return x2;
      } }]), t2;
    }();
    ...
    var X = function() {
      ...
      return a(t2, [{ key: "initVariables", value: function(t3) {
        ...
        return n2.globals.seriesGoals[a2] && n2.globals.seriesGoals[a2][r2] && Array.isArray(n2.globals.seriesGoals[a2][r2]) && n2.globals.seriesGoals[a2][r2].forEach(function(a3) {
          var r3;
          l2.push((s(r3 = {}, t3, t3 === "x" ? o2.getXForValue(a3.value, e2, false) : o2.getYForValue(a3.value, i2, false)), s(r3, "attrs", a3), r3));
        }), l2;
    ...
    var E = function() {
      function t2(i2, a2) {
        e(this, t2), this.ctx = i2, this.w = i2.w;
        var s2 = this.w;
        this.barOptions = s2.config.plotOptions.bar, this.isHorizontal = this.barOptions.horizontal, this.strokeWidth = s2.config.stroke.width, this.isNullValue = false, this.isRangeBar = s2.globals.seriesRangeBar.length && this.isHorizontal, this.xyRatios = a2, this.xyRatios !== null && (this.xRatio = a2.xRatio, this.initialXRatio = a2.initialXRatio, this.yRatio = a2.yRatio, this.invertedXRatio = a2.invertedXRatio, this.invertedYRatio = a2.invertedYRatio, this.baseLineY = a2.baseLineY, this.baseLineInvertedY = a2.baseLineInvertedY), this.yaxisIndex = 0, this.seriesLen = 0, this.barHelpers = new X(this);
      }
      return a(t2, [{ key: "draw", value: function(t3, e2) {
        ...
        for (var n2 = 0, l2 = 0; n2 < t3.length; n2++, l2++) {
          ...
          for (var C2 = a2.group({ class: "apexcharts-datalabels", "data:realIndex": m2 }), L2 = a2.group({ class: "apexcharts-bar-goals-markers", style: "pointer-events: none" }), P2 = 0; P2 < i2.globals.dataPoints; P2++) {
            ...
            this.isHorizontal ? (M2 = this.drawBarPaths(o(o({}, I2), {}, { barHeight: k2, zeroW: g2, yDivision: c2 })), A2 = this.series[n2][P2] / this.invertedYRatio) : (M2 = this.drawColumnPaths(o(o({}, I2), {}, { xDivision: h2, barWidth: A2, zeroH: d2 })), k2 = this.series[n2][P2] / this.yRatio[this.yaxisIndex]);
      ...
      return a(s2, [{ key: "draw", value: function(t3, e2) {
        ...
        for (var s3 = a2.group({ class: "apexcharts-rangebar-series apexcharts-plot-series" }), r2 = 0; r2 < t3.length; r2++) {
          ...
          for (var y2 = a2.group({ class: "apexcharts-datalabels", "data:realIndex": u2 }), w2 = a2.group({ class: "apexcharts-rangebar-goals-markers", style: "pointer-events: none" }), k2 = 0; k2 < i3.globals.dataPoints; k2++) {
            var A2 = this.barHelpers.getStrokeWidth(r2, k2, u2), S2 = this.seriesRangeStart[r2][k2], C2 = this.seriesRangeEnd[r2][k2], L2 = null, P2 = null, T2 = { x: c2, y: d2, strokeWidth: A2, elSeries: f2 };
            if (g2 = m2.yDivision, x2 = m2.barHeight, this.isHorizontal) {
              P2 = d2 + x2 * this.visibleI;
              var M2 = this.seriesLen;
              i3.config.plotOptions.bar.rangeBarGroupRows && (M2 = 1);
              var I2 = (g2 - x2 * M2) / 2;
              if (i3.config.series[r2].data[k2] === void 0)
                break;
              ...
              v2 = (L2 = this.drawRangeBarPaths(o({ indexes: { i: r2, j: k2, realIndex: u2 }, barHeight: x2, barYPosition: P2, zeroW: h2, yDivision: g2, y1: S2, y2: C2 }, T2))).barWidth;
            } else
              x2 = (L2 = this.drawRangeColumnPaths(o({ indexes: { i: r2, j: k2, realIndex: u2 }, zeroH: l2, barWidth: v2, xDivision: n2 }, T2))).barHeight;
    ...
    var H = function() {
      ...
      return a(i2, [{ key: "init", value: function(e2) {
        ...
        if (a2 && t(a2) === "object") {
          var l2 = {};
          l2 = ["line", "area", "bar", "candlestick", "boxPlot", "rangeBar", "histogram", "bubble", "scatter", "heatmap", "treemap", "pie", "polarArea", "donut", "radar", "radialBar"].indexOf(a2.chart.type) !== -1 ? r2[a2.chart.type]() : r2.line(), a2.chart.brush && a2.chart.brush.enabled && (l2 = r2.brush(l2)), a2.chart.stacked && a2.chart.stackType === "100%" && (a2 = r2.stacked100(a2)), this.checkForDarkTheme(window.Apex), this.checkForDarkTheme(a2), a2.xaxis = a2.xaxis || window.Apex.xaxis || {}, i3 || (a2.xaxis.convertedCatToNumeric = false), ((a2 = this.checkForCatToNumericXAxis(this.chartType, l2, a2)).chart.sparkline && a2.chart.sparkline.enabled || window.Apex.chart && window.Apex.chart.sparkline && window.Apex.chart.sparkline.enabled) && (l2 = r2.sparkline(l2)), n2 = p.extend(o2, l2);
        }
        ...
        var a2 = new R(i3), s2 = t2 === "bar" && i3.plotOptions && i3.plotOptions.bar && i3.plotOptions.bar.horizontal, r2 = t2 === "pie" || t2 === "polarArea" || t2 === "donut" || t2 === "radar" || t2 === "radialBar" || t2 === "heatmap", o2 = i3.xaxis.type !== "datetime" && i3.xaxis.type !== "numeric", n2 = i3.xaxis.tickPlacement ? i3.xaxis.tickPlacement : e2.xaxis && e2.xaxis.tickPlacement;
        return s2 || r2 || !o2 || n2 === "between" || (i3 = a2.convertCatToNumeric(i3)), i3;
        ...
        var e2 = new S();
        return t2.annotations.yaxis = p.extendArray(t2.annotations.yaxis !== void 0 ? t2.annotations.yaxis : [], e2.yAxisAnnotation), t2;
      } }, { key: "extendXAxisAnnotations", value: function(t2) {
        var e2 = new S();
        return t2.annotations.xaxis = p.extendArray(t2.annotations.xaxis !== void 0 ? t2.annotations.xaxis : [], e2.xAxisAnnotation), t2;
      } }, { key: "extendPointAnnotations", value: function(t2) {
        var e2 = new S();
        return t2.annotations.points = p.extendArray(t2.annotations.points !== void 0 ? t2.annotations.points : [], e2.pointAnnotation), t2;
    ...
    var G = function() {
      function t2(i2) {
        e(this, t2), this.ctx = i2, this.w = i2.w;
        var a2 = this.w;
        this.axesUtils = new B(i2), this.xaxisLabels = a2.globals.labels.slice(), a2.globals.timescaleLabels.length > 0 && !a2.globals.isBarHorizontal && (this.xaxisLabels = a2.globals.timescaleLabels.slice()), a2.config.xaxis.overwriteCategories && (this.xaxisLabels = a2.config.xaxis.overwriteCategories), this.drawnLabels = [], this.drawnLabelsRects = [], a2.config.xaxis.position === "top" ? this.offY = 0 : this.offY = a2.globals.gridHeight + 1, this.offY = this.offY + a2.config.xaxis.axisBorder.offsetY, this.isCategoryBarHorizontal = a2.config.chart.type === "bar" && a2.config.plotOptions.bar.horizontal, this.xaxisFontSize = a2.config.xaxis.labels.style.fontSize, this.xaxisFontFamily = a2.config.xaxis.labels.style.fontFamily, this.xaxisForeColors = a2.config.xaxis.labels.style.colors, this.xaxisBorderWidth = a2.config.xaxis.axisBorder.width, this.isCategoryBarHorizontal && (this.xaxisBorderWidth = a2.config.yaxis[0].axisBorder.width.toString()), this.xaxisBorderWidth.indexOf("%") > -1 ? this.xaxisBorderWidth = a2.globals.gridWidth * parseInt(this.xaxisBorderWidth, 10) / 100 : this.xaxisBorderWidth = parseInt(this.xaxisBorderWidth, 10), this.xaxisBorderHeight = a2.config.xaxis.axisBorder.height, this.yaxis = a2.config.yaxis[0];
      }
    ...
    var lt = function() {
      function t2(i2, a2) {
        e(this, t2), this.ctx = i2, this.w = i2.w, this.onLegendClick = this.onLegendClick.bind(this), this.onLegendHovered = this.onLegendHovered.bind(this), this.isBarsDistributed = this.w.config.chart.type === "bar" && this.w.config.plotOptions.bar.distributed && this.w.config.series.length === 1, this.legendHelpers = new nt(this);
      }
      return a(t2, [{ key: "init", value: function() {
    ...
    var ct = function(t2) {
      ...
      return a(s2, [{ key: "init", value: function(t3) {
        ...
        e2.shiftKey ? (this.shiftWasPressed = true, s3.enableZoomPanFromToolbar(o2 === "pan" ? "zoom" : "pan")) : this.shiftWasPressed && (s3.enableZoomPanFromToolbar(o2), this.shiftWasPressed = false);
        var n2 = e2.target.classList;
        if (!(n2.contains("apexcharts-selection-rect") || n2.contains("apexcharts-legend-marker") || n2.contains("apexcharts-legend-text") || e2.target.parentNode.classList.contains("apexcharts-toolbar"))) {
        ...
        var e2 = t3.x, i3 = t3.y, a2 = t3.width, s3 = t3.height, r2 = t3.translateX, o2 = r2 === void 0 ? 0 : r2, n2 = t3.translateY, l2 = n2 === void 0 ? 0 : n2, h2 = this.w, c2 = this.zoomRect, d2 = this.selectionRect;
        ...
        return Math.abs(c2 + o2) > a2.globals.gridWidth ? c2 = a2.globals.gridWidth - o2 : s3.clientX - r2.left < 0 && (c2 = o2), o2 > s3.clientX - r2.left && (l2 = true, c2 = Math.abs(c2)), n2 > s3.clientY - r2.top && (h2 = true, d2 = Math.abs(d2)), g2 = i3 === "x" ? { x: l2 ? o2 - c2 : o2, y: 0, width: c2, height: a2.globals.gridHeight } : i3 === "y" ? { x: 0, y: h2 ? n2 - d2 : n2, width: a2.globals.gridWidth, height: d2 } : { x: l2 ? o2 - c2 : o2, y: h2 ? n2 - d2 : n2, width: c2, height: d2 }, s3.drawSelectionRect(g2), s3.selectionDragging("resizing"), g2;
        ...
        if (a2.config.yaxis.forEach(function(t4, e3) {
          ...
          if (a2.globals.zoomEnabled) {
            ...
            if (a2.globals.zoomed = true, a2.config.xaxis.convertedCatToNumeric && (h2 = Math.floor(h2), c2 = Math.floor(c2), h2 < 1 && (h2 = 1, c2 = a2.globals.dataPoints), c2 - h2 < 2 && (c2 = h2 + 1)), i3 !== "xy" && i3 !== "x" || (f2 = { min: h2, max: c2 }), i3 !== "xy" && i3 !== "y" || u2.forEach(function(t4, e3) {
            ...
            var v2 = { xaxis: f2 };
            a2.config.chart.group || (v2.yaxis = u2), s3.ctx.updateHelpers._updateOptions(v2, false, s3.w.config.chart.animations.dynamicAnimation.enabled), typeof a2.config.chart.events.zoomed == "function" && o2.zoomCallback(f2, u2);
          } else if (a2.globals.selectionEnabled) {
            var m2, y2 = null;
            m2 = { min: h2, max: c2 }, i3 !== "xy" && i3 !== "y" || (y2 = p.clone(a2.config.yaxis)).forEach(function(t4, e3) {
              y2[e3].min = g2[e3], y2[e3].max = d2[e3];
            }), a2.globals.selection = s3.selection, typeof a2.config.chart.events.selection == "function" && a2.config.chart.events.selection(s3.ctx, { xaxis: m2, yaxis: y2 });
          }
        }
        ...
        i3.globals.isRangeBar && (r2 = a2.invertedYRatio, o2 = i3.globals.minY, n2 = i3.globals.maxY), this.moveDirection === "left" ? (t3 = o2 + i3.globals.gridWidth / 15 * r2, e2 = n2 + i3.globals.gridWidth / 15 * r2) : this.moveDirection === "right" && (t3 = o2 - i3.globals.gridWidth / 15 * r2, e2 = n2 - i3.globals.gridWidth / 15 * r2), i3.globals.isRangeBar || (t3 < i3.globals.initialMinX || e2 > i3.globals.initialMaxX) && (t3 = o2, e2 = n2);
    ...
    var gt = function() {
      ...
      return a(t2, [{ key: "drawSeriesTexts", value: function(t3) {
        ...
        s2 !== null && c2.config.plotOptions.bar.distributed && (b2 = c2.globals.colors[s2]);
        for (var v2 = function(t4, r3) {
          var v3 = i2.getFormatters(a2);
          x2 = i2.getSeriesName({ fn: v3.yLbTitleFormatter, index: a2, seriesIndex: a2, j: s2 }), c2.config.chart.type === "treemap" && (x2 = v3.yLbTitleFormatter(String(c2.config.series[a2].data[s2].x), { series: c2.globals.series, seriesIndex: a2, dataPointIndex: s2, w: c2 }));
          ...
          s2 === null && (e2 = v3.yLbFormatter(c2.globals.series[a2], o(o({}, c2), {}, { seriesIndex: a2, dataPointIndex: a2 }))), i2.DOMHandling({ i: a2, t: m3, j: s2, ttItems: n2, values: { val: e2, goalVals: d2, xVal: u2, xAxisTTVal: f2, zVal: p2 }, seriesName: x2, shared: l2, pColor: b2 });
    ...
    var ut = function() {
      ...
      return a(t2, [{ key: "moveXCrosshairs", value: function(t3) {
        ...
        if (e2 !== null && (r2 = a2.globals.gridWidth / o2 * e2), s2 !== null && (s2.setAttribute("x", r2), s2.setAttribute("x1", r2), s2.setAttribute("x2", r2), s2.setAttribute("y2", a2.globals.gridHeight), s2.classList.add("apexcharts-active")), r2 < 0 && (r2 = 0), r2 > a2.globals.gridWidth && (r2 = a2.globals.gridWidth), i2.blxaxisTooltip) {
          var n2 = r2;
    ...
    var mt = function(t2) {
      ...
      return a(s2, [{ key: "draw", value: function(t3, e2) {
        ...
        for (var n2 = s3.group({ class: "apexcharts-".concat(a2.config.chart.type, "-series apexcharts-plot-series") }), l2 = function(o3) {
          i3.isBoxPlot = a2.config.chart.type === "boxPlot" || a2.config.series[o3].type === "boxPlot";
    ...
    var St = function() {
      ...
      return a(t2, [{ key: "draw", value: function(t3) {
        var e2 = this, i2 = this.w, a2 = new L(this.ctx), s2 = [], r2 = new M(this.ctx);
        ...
        if (this.yaxisLabels = this.graphics.group({ class: "apexcharts-yaxis" }), t3.forEach(function(t4, n3) {
          ...
          for (var v2 = 0; v2 < c3.linePathsTo.length; v2++) {
            var m2 = e2.graphics.renderPaths(o(o({}, d3), {}, { pathFrom: b3 === null ? c3.linePathsFrom[v2] : b3, pathTo: c3.linePathsTo[v2], strokeWidth: Array.isArray(e2.strokeWidth) ? e2.strokeWidth[n3] : e2.strokeWidth, fill: "none", drawShadow: false }));
            h3.add(m2);
            var y2 = a2.fillPath({ seriesNumber: n3 }), w2 = e2.graphics.renderPaths(o(o({}, d3), {}, { pathFrom: b3 === null ? c3.areaPathsFrom[v2] : b3, pathTo: c3.areaPathsTo[v2], strokeWidth: 0, fill: y2, drawShadow: false }));
        ...
        return e2.globals.labels.forEach(function(r2, n2) {
          var l2 = e2.config.xaxis.labels.formatter, h2 = new M(t3.ctx);
          if (s2[n2]) {
    ...
    var Ct = function(t2) {
      ...
      return a(s2, [{ key: "draw", value: function(t3) {
        ...
        e2.config.plotOptions.radialBar.hollow.image !== void 0 && (n2 = this.drawHollowImage(t3, r2, l2, n2));
        ...
        for (var v2 = f2 ? t3.series.length - 1 : 0; f2 ? v2 >= 0 : v2 < t3.series.length; f2 ? v2-- : v2++) {
          ...
          var P2 = S2 - w2, T2 = Array.isArray(e2.config.stroke.dashArray) ? e2.config.stroke.dashArray[v2] : e2.config.stroke.dashArray, M2 = i3.drawPath({ d: "", stroke: y2, strokeWidth: o2, fill: "none", fillOpacity: e2.config.fill.opacity, classes: "apexcharts-radialbar-area apexcharts-radialbar-slice-" + v2, strokeDashArray: T2 });
          if (b.setAttrs(M2.node, { "data:angle": P2, "data:value": t3.series[v2] }), e2.config.chart.dropShadow.enabled) {
            var I2 = e2.config.chart.dropShadow;
            s3.dropShadow(M2, I2, v2);
          }
          s3.setSelectionFilter(M2, 0, v2), this.addListeners(M2, this.radialDataLabels), m2.add(M2), M2.attr({ index: 0, j: v2 });
          var z2 = 0;
    ...
    var Pt = function() {
      ...
      return a(t2, [{ key: "draw", value: function(t3, e2, i2) {
        ...
        if (r2.config.stroke.show && !this.pointsChart) {
          var v2 = null;
          v2 = e2 === "line" ? l2.fillPath({ seriesNumber: i2, i: a2 }) : r2.globals.stroke.colors[i2];
    ...
    var zt = function() {
      ...
      return a(t2, [{ key: "calculateTimeScaleTicks", value: function(t3, e2) {
        ...
        var y2 = this.timeScaleArray.map(function(t4) {
          ...
          return t4.unit === "month" ? o(o({}, e3), {}, { day: 1, value: t4.value + 1 }) : t4.unit === "day" || t4.unit === "hour" ? o(o({}, e3), {}, { value: t4.value }) : t4.unit === "minute" ? o(o({}, e3), {}, { value: t4.value, minute: t4.value }) : t4.unit === "second" ? o(o({}, e3), {}, { value: t4.value, minute: t4.minute, second: t4.second }) : t4;
        });
        return y2.filter(function(t4) {
          ...
          switch (i2.tickInterval) {
            case "years":
              t4.unit === "year" && (o2 = true);
              break;
            case "half_year":
              e3 = 7, t4.unit === "year" && (o2 = true);
              break;
            case "months":
              e3 = 1, t4.unit === "year" && (o2 = true);
              break;
            case "months_fortnight":
              e3 = 15, t4.unit !== "year" && t4.unit !== "month" || (o2 = true), r3 === 30 && (n3 = true);
              break;
            case "months_days":
              e3 = 10, t4.unit === "month" && (o2 = true), r3 === 30 && (n3 = true);
              break;
            case "week_days":
              e3 = 8, t4.unit === "month" && (o2 = true);
              break;
            case "days":
              e3 = 1, t4.unit === "month" && (o2 = true);
              break;
            case "hours":
              t4.unit === "day" && (o2 = true);
              break;
    ...
    var Et = function() {
      ...
      return a(i2, [{ key: "_updateOptions", value: function(e2) {
        var i3 = this, a2 = arguments.length > 1 && arguments[1] !== void 0 && arguments[1], s2 = !(arguments.length > 2 && arguments[2] !== void 0) || arguments[2], r2 = !(arguments.length > 3 && arguments[3] !== void 0) || arguments[3], o2 = arguments.length > 4 && arguments[4] !== void 0 && arguments[4], n2 = [this.ctx];
        r2 && (n2 = this.ctx.getSyncedCharts()), this.ctx.w.globals.isExecCalled && (n2 = [this.ctx], this.ctx.w.globals.isExecCalled = false), n2.forEach(function(r3) {
          var n3 = r3.w;
          return n3.globals.shouldAnimate = s2, a2 || (n3.globals.resized = true, n3.globals.dataChanged = true, s2 && r3.series.getPreviousPaths()), e2 && t(e2) === "object" && (r3.config = new H(e2), e2 = y.extendArrayProps(r3.config, e2, n3), r3.w.globals.chartID !== i3.ctx.w.globals.chartID && delete e2.series, n3.config = p.extend(n3.config, e2), o2 && (n3.globals.lastXAxis = e2.xaxis ? p.clone(e2.xaxis) : [], n3.globals.lastYAxis = e2.yaxis ? p.clone(e2.yaxis) : [], n3.globals.initialConfig = p.extend({}, n3.config), n3.globals.initialSeries = p.clone(n3.config.series))), r3.update(e2);
        });
        ...
        })).length === 0 && (i3 = [{ data: [] }]), r2.config.series = i3) : r2.config.series = t2.slice(), s2 && (r2.globals.initialSeries = p.clone(r2.config.series)), this.ctx.update();
    ...
    Tt = typeof window != "undefined" ? window : void 0, Mt = function(e2, i2) {
      ...
      a2.PathArray = function(t2, e3) {
        ...
        do {
          a2.regex.isPathLetter.test(t2[l3]) ? (e3 = t2[l3], ++l3) : e3 == "M" ? e3 = "L" : e3 == "m" && (e3 = "l"), r3.push(s2[e3].call(null, t2.slice(l3, l3 += i3[e3.toUpperCase()]).map(parseFloat), o3, n3));
        } while (c3 > l3);
        return r3;
      }, bbox: function() {
        ...
        e3 = e3 === null ? i3 : e3 instanceof a2.Element ? e3.matrixify() : typeof e3 == "string" ? f2(e3.split(a2.regex.delimiter).map(parseFloat)) : arguments.length == 6 ? f2([].slice.call(arguments)) : Array.isArray(e3) ? f2(e3) : e3 && t(e3) === "object" ? e3 : i3;
        for (var s3 = m2.length - 1; s3 >= 0; --s3)
          this[m2[s3]] = e3[m2[s3]] != null ? e3[m2[s3]] : i3[m2[s3]];
        ...
        return (this.attr("transform") || "").split(a2.regex.transforms).slice(0, -1).map(function(t2) {
          ...
          return e3[0] == "matrix" ? t2.multiply(f2(e3[1])) : t2[e3[0]].apply(t2, e3[1]);
        }, new a2.Matrix());
    ...
    }) : (typeof exports == "undefined" ? "undefined" : t(exports)) === "object" && typeof module != "undefined" ? module.exports = Tt.document ? Mt(Tt, Tt.document) : function(t2) {
    ...
    !function(t2, e2) {
      ...
      if (c2.style.animationName !== void 0 && (o2 = true), o2 === false) {
