<template>
   <div class="flex justify-between px-4 mt-5 sm:px-8 pt-4">
    <div class="flex items-center space-x-1 text-xs text-base">
      ...
      <span class="text-gray-600">Tambah Berita</span>
    </div>
      ...
      <div>
         <table class="border-collapse border border-slate-400 w-full">
            ...
            <tbody>
               <tr>
                ...
                <td class="border border-slate-300 ... p-2"><input class="appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" v-model="form.judul"></td>
              </tr>
               <tr>
                <td class="border border-slate-300 ... p-2 text-gray-600">Meta Deskripsi</td>
                <td class="border border-slate-300 ... p-2"><input class="appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" v-model="form.meta_description"></td>
              </tr>
                 <tr>
                <td class="border border-slate-300 ... p-2 text-gray-600">Sub Deskripsi</td>
                <td class="border border-slate-300 ... p-2"><input class="appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" v-model="form.sub_description"></td>
              </tr>
                <tr>
                <td class="border border-slate-300 ... p-2 text-gray-600">Tag</td>
                <td class="border border-slate-300 ... p-2"><input class="appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" v-model="form.tag"></td>
              </tr>
             ...
             <tr>
                ...
                <td class="border border-slate-300 ... p-2"><textarea class="appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" v-model="form.isi_berita"></textarea></td>
              </tr>
              <tr>
         ...
         <div class="text-right py-2">
           <router-link to="/tim">
              ...
              <span class="ml-1" @click="tambahBerita">TAMBAH</span>
              </button>
      </div>
      </div>
    </div>
  ...
  methods:{
    onFileSelected(event){
     ...
     tambahBerita(){
            ...
            StatistikService.tambahBeritalog(fd)
            .then(response => {
