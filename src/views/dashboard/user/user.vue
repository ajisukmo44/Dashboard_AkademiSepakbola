    ...
    <div class="p-5 bg-white rounded">
      <div class="flex mb-5 justify-between">
        ...
        <thead class="border-b">
          <tr>
            <th class="text-left text-gray-600" width="3%">
             NO
            </th>
            <th class="text-left text-gray-600">NAMA PENGGUNA</th>
            <th class="text-left text-gray-600" width="20%">TIPE</th>
            <th class="text-left text-gray-600" width="15%">BERGABUNG</th>
            <th class="text-right text-gray-600" width="10%">TINDAKAN</th>
          </tr>
        </thead>
        <tbody class="divide-y divide-gray-200">
            <tr v-for="(data, index) in user" :key="index.id">
              ...
              <td class="py-1 text-right">
                <router-link :to="{ name:'tim-detail', params: { id:data.id}}"><button class="bg-yellow-400 hover:bg-yellow-500 text-white font-normal py-2 px-2 rounded">
