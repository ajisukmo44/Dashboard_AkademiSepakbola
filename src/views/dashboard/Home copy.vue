<template>
  <div class="flex dark justify-between px-4 mt-4 sm:px-8 dark">
    ...
    <div class="flex items-center space-x-1 text-xs">
      ...
      <span class="text-gray-600">Dashboardx</span>
    </div>
  </div>
  ...
  <div class="grid grid-cols-1 px-4 gap-4 mt-8 sm:grid-cols-5 sm:px-8">
    <div class="px-4 py-2 bg-white border overflow-hidden shadow sm:col-span-3" >
       <div class="flex justify-between items-center px-4 py-2 mb-2 border-b-2 text-gray-600">
        <h3 class="text-xl text-gray-600 mb-2">Tim Baru Bergabung {{label}}</h3>
        <button class="border  bg-gray-200 px-4 py-2 text-xs hover:bg-gray-300">View All</button>
      </div>
      <div class="px-4">
      ...
      <div class="px-4 py-2 bg-white border shadow">
        <h3 class="text-xl text-gray-600 mb-2">Top Provinsi</h3>
              ...
              <table class="table-auto min-w-full divide-y divide-gray-200">
                <thead>
                  <tr>
                    ...
                    <th scope="col" class="py-3 text-xs font-medium text-gray-500 uppercase tracking-wider text-right">
                      Total Tim
                    </th>
                  </tr>
                </thead>
                <tbody class="divide-y divide-gray-200 text-sm text-gray-500">
                  <tr>
                    <td class="py-1">Jawa Timur</td>
                    <td class="py-1 text-sm text-gray-500 text-right">1,672</td>
                  </tr>
                    <tr>
                    <td class="py-1">Jawa Timur</td>
                    <td class="py-1 text-sm text-gray-500 text-right">1,672</td>
                  ...
                  <tr>
                    <td class="py-1">Jawa Tengah</td>
                    <td class="py-1 text-sm text-gray-500 text-right">1,423</td>
                  </tr>
                  <tr>
                    <td class="py-1">Yogyakarta</td>
                    <td class="py-1 text-sm text-gray-500 text-right">926</td>
                  </tr>
                   <tr>
                    <td class="py-1">Jawa Timur</td>
                    <td class="py-1 text-sm text-gray-500 text-right">1,672</td>
