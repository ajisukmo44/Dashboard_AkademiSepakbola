  ...
  <div class="px-4 mt-3 sm:px-8">
    <div class="p-5 bg-white rounded">
      <div class="flex mb-5 justify-between">
        <div class="flex mb-2">
          <!-- <router-link to="/tambah-tim">
            <button class="flex-none items-center bg-green-500 p-2 px-3 mr-1 text-white rounded text-sm hover:bg-green-600">
              Tambah Tim
            </button>
          </router-link>

          <router-link to="/tim-new">
            <button class="flex-none items-center bg-blue-500 p-2 px-3 text-white rounded text-sm hover:bg-blue-600">
              Tim Baru
            </button>
          </router-link> -->
        ...
        <tbody class="divide-y divide-gray-200">
            <tr v-for="(data, index) in tim" :key="index.id">
              ...
              <td class="py-1 text-right">
                <router-link :to="{ name:'tim-detail', params: { id:data.id}}"><button class="bg-gray-200 mr-1 hover:bg-gray-300 text-gray-600 font-normal py-2 px-2 rounded">
                   <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                  </svg>
                </button>
                </router-link>
                <button class="bg-gray-200 hover:bg-gray-300 text-gray-600 font-normal py-2 px-2 rounded" @click="timDelete(data.id)"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
