<template>
   <aside class="hidden w-64 bg-gray-800 sm:block">
    <div class="py-3 px-2 text-xl uppercase text-left tracking-widest bg-gray-900 border-b-2 border-gray-800 mb-8">
     
      <router-link to="/" class="text-white">Akademi <br> Sepakbola</router-link>
       
    </div>

    <nav class="text-sm text-gray-300">
      <ul class="flex flex-col">
        <li class="px-4 py-2 text-xs uppercase tracking-wider text-gray-500 font-bold">Data Utama</li>
        ...
        <!-- <li>
          ...
          <router-link to="/teams" class="py-2 flex items-center">
        ...
        <li class="px-4 hover:bg-gray-700">
          <router-link to="/berita" class="py-2 flex items-center">
           <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <li class="px-4 py-2 mt-2 text-xs uppercase tracking-wider text-gray-500 font-bold">Informasi</li>
        ...
        <li class="px-4 py-2 mt-2 text-xs uppercase tracking-wider text-gray-500 font-bold">Pengaturan</li>

        <li class="px-4 cursor-pointer hover:bg-gray-700">
          <router-link :to="{ name: 'user' }" class="py-2 flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
         ...
         <li class="px-4 cursor-pointer hover:bg-gray-700">
          <router-link :to="{ name: 'kategori-tim' }" class="py-2 flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
         ...
         <li class="px-4 cursor-pointer hover:bg-gray-700">
          <router-link :to="{ name: 'kategori-berita' }" class="py-2 flex items-center">
           <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
          </svg>
            Kategori Berita
        ...
        <li class="px-4 py-2 mt-2 text-xs uppercase tracking-wider text-gray-500 font-bold">Aksi</li>
