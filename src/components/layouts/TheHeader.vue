<template>
  <header class="flex justify-between bg-white border-b-2 px-4 py-2 sm:justify-end sm:px-6">
        ...
        >
          <div>
            ...
            <MenuItem v-slot="{ active }">
              <a :href="href" @click="navigate" :class="[active ? 'bg-gray-200' : '', 'block px-4 py-2 text-sm text-gray-700']"
                >Your Profile</a
              >
            </MenuItem>
            </router-link>
